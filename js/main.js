...
const sectionInitialized = { survey: false, visualize: false, game: false };
...
function switchTab(tabName) {
    ...
    // Hide all sections
    const allSections = [sectionGallery, sectionProcess, sectionSurvey, sectionVisualize, sectionGame];
    allSections.forEach(s => { if (s) s.style.display = 'none'; });

    const tabIndex = { gallery: 0, process: 1, survey: 2, visualize: 3, game: 4 };
